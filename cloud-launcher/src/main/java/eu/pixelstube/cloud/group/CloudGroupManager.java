...
public class CloudGroupManager implements ICloudGroupManager {
        ...
        CloudLauncher.getInstance().getDatabaseAdapter().executeQuery("SELECT * FROM cloud_groups", resultSet -> {
            ...
            try {
                ...
                while (resultSet.next()){
                    ...
                    String templateName = resultSet.getString("template");
                    ...
                    cloudGroups.add(new ICloudGroup() {
                        ...
                        public ITemplate getTemplate() {
                            return CloudLauncher.getInstance().getTemplateManager().getCachedTemplate(templateName);
                        }
                    });
                }
    ...
    public void createGroup(String name, int maxServices, int minServices, int maxMemory, int percentage, GroupVersion groupVersion, GroupType groupType, String template, String maintenance){
